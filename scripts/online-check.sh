#!/bin/bash
# =====================================================
# online-check.sh - ShowOn Online Users Checker (FULL)
...
DEBUG_LOG="${DEBUG_LOG:-/var/log/showon_debug.log}"
...
while true; do
  ...
  echo "[INFO] Updated online_app.json at $(date '+%H:%M:%S') - Total: $TOTAL" >> "$DEBUG_LOG"
